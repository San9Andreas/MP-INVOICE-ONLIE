...
//
//  To connect to Firestore, create a .env file in the project root
//  with the following variables from your Firebase Console:
//
...
if (isConfigured) {
  ...
  firebaseError = 'Firebase not configured — using local storage. Add VITE_FIREBASE_* env vars to enable Firestore.';
  console.info(firebaseError);
}

export { app, db, firebaseError, isConfigured };
