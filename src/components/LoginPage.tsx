    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white tracking-tight">Invoice Pro</h1>
          <p className="text-slate-400 mt-2 text-lg">Cloud-powered invoice management</p>
        </div>

        {/* Login Card */}
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8">
          <h2 className="text-xl font-semibold text-white mb-1 text-center">Welcome</h2>
          ...
          {!isConfigured && (
            <div className="mt-6 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
              ...
              <p className="text-amber-200/70 text-xs leading-relaxed">
                Google Sign-In requires Firebase. Create a{' '}
                <code className="bg-white/10 px-1.5 py-0.5 rounded text-amber-200">.env</code> file
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <div className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-bold text-amber-300 uppercase">Owner</span>
            </div>
            <ul className="space-y-1">
              <li className="text-[11px] text-slate-400 flex items-center gap-1.5">
                <CheckCircle className="w-2.5 h-2.5 text-emerald-400" /> Create invoices
              </li>
              <li className="text-[11px] text-slate-400 flex items-center gap-1.5">
                <CheckCircle className="w-2.5 h-2.5 text-emerald-400" /> Edit & delete
              </li>
              <li className="text-[11px] text-slate-400 flex items-center gap-1.5">
                <CheckCircle className="w-2.5 h-2.5 text-emerald-400" /> Full admin access
              </li>
            </ul>
          </div>
          <div className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-bold text-sky-300 uppercase">Staff</span>
            </div>
            <ul className="space-y-1">
              <li className="text-[11px] text-slate-400 flex items-center gap-1.5">
                <CheckCircle className="w-2.5 h-2.5 text-emerald-400" /> Create invoices
              ...
              <li className="text-[11px] text-slate-400 flex items-center gap-1.5">
                <CheckCircle className="w-2.5 h-2.5 text-emerald-400" /> View & print
              </li>
              <li className="text-[11px] text-slate-400 flex items-center gap-1.5">
                <span className="w-2.5 h-2.5 rounded-full border border-slate-500 flex-shrink-0" /> No edit/delete
              </li>
            </ul>
          </div>
        </div>
        ...
        <p className="text-center text-slate-600 text-xs mt-6">
          First user to sign in automatically becomes the <strong className="text-slate-500">Owner</strong>.
          <br />
          All subsequent users join as <strong className="text-slate-500">Staff</strong>.
        </p>
      </div>
    </div>
  );
